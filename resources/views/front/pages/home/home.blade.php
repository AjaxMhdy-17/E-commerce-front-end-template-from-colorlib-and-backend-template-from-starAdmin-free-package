...
@section('content')
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{ asset($feat->image_one) }}" alt="img"></div>
                                    ...
                                    @forelse ($trends as $trend)
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset($trend->image_one) }}" alt="img"></div>
                                                <div class="product_content">
                                                    <div class="product_price discount">
                                    ...
                                    @forelse ($bestRateds as $rate)
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset($rate->image_one) }}" alt="img"></div>
                                                <div class="product_content">
                                                    <div class="product_price discount">
                                    ...
                                    <div class="arrivals_slider slider">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('uset/assets/images/new_1.jpg') }}"
                                                        alt="img"></div>
                                                <div class="product_content">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('uset/assets/images/new_2.jpg') }}"
                                                        alt="img"></div>
                                                <div class="product_content">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('uset/assets/images/new_3.jpg') }}"
                                                        alt="img"></div>
                                                <div class="product_content">
                                                    <div class="product_price">$379</div>
                                                    <div class="product_name">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('uset/assets/images/new_4.jpg') }}"
                                                        alt="img"></div>
                                                <div class="product_content">
                                                    <div class="product_price">$225</div>
                                                    <div class="product_name">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('uset/assets/images/new_5.jpg') }}"
                                                        alt="img"></div>
                                                <div class="product_content">
                                                    <div class="product_price">$225</div>
                                                    <div class="product_name">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('uset/assets/images/new_6.jpg') }}"
                                                        alt="img"></div>
                                                <div class="product_content">
                                                    <div class="product_price">$379</div>
                                                    <div class="product_name">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('uset/assets/images/new_7.jpg') }}"
                                                        alt="img"></div>
                                                <div class="product_content">
                                                    <div class="product_price">$379</div>
                                                    <div class="product_name">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('uset/assets/images/new_8.jpg') }}"
                                                        alt="img"></div>
                                                <div class="product_content">
                                                    <div class="product_price">$225</div>
                                                    <div class="product_name">
                                ...
                                <div class="arrivals_single clearfix">
                                    <div class="d-flex flex-column align-items-center justify-content-center">
                                        <div class="arrivals_single_image"><img
                                                src="{{ asset('uset/assets/images/new_single.png') }}" alt="img">
                                        </div>
                            ...
                            <div class="bestsellers_slider slider">
                                ...
                                <div class="bestsellers_item discount">
                                    <div
                                        ...
                                        <div class="bestsellers_image"><img
                                                src="{{ asset('uset/assets/images/best_1.png') }}" alt="img">
                                        </div>
                                ...
                                <div class="bestsellers_item discount">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img
                                                src="{{ asset('uset/assets/images/best_2.png') }}" alt="img">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="bestsellers_item">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img
                                                src="{{ asset('uset/assets/images/best_3.png') }}" alt="img">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="bestsellers_item">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img
                                                src="{{ asset('uset/assets/images/best_4.png') }}" alt="img">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="bestsellers_item discount">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img
                                                src="{{ asset('uset/assets/images/best_5.png') }}" alt="img">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                ...
                                <div class="bestsellers_item">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img
                                                src="{{ asset('uset/assets/images/best_6.png') }}" alt="img">
                                        </div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 advert_col">
                    ...
                    <div class="advert d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="ml-auto">
                            <div class="advert_image"><img src="{{ asset('uset/assets/images/adv_1.png') }}"
                                    alt="img"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 advert_col">
                    ...
                    <div class="advert d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="ml-auto">
                            <div class="advert_image"><img src="{{ asset('uset/assets/images/adv_2.png') }}"
                                    alt="img"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 advert_col">
                    ...
                    <div class="advert d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="ml-auto">
                            <div class="advert_image"><img src="{{ asset('uset/assets/images/adv_3.png') }}"
                                    alt="img"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="trends">
        <div class="trends_background"
            style="background-image: url('{{ asset('uset/assets/images/trends_background.jpg') }}')"></div>
                        ...
                        <div class="owl-carousel owl-theme trends_slider">
                            ...
                            <div class="owl-item">
                                <div class="trends_item is_new">
                                    <div
                                        ...
                                        <img src="{{ asset('uset/assets/images/trends_1.jpg') }}" alt="img">
                                    </div>
                            ...
                            <div class="owl-item">
                                <div class="trends_item">
                                    <div
                                        class="trends_image d-flex flex-column align-items-center justify-content-center">
                                        <img src="{{ asset('uset/assets/images/trends_2.jpg') }}" alt="img">
                                    </div>
                                    <div class="trends_content">
                                        <div class="trends_category"><a href="#">Smartphones</a></div>
                                        <div class="trends_info clearfix">
                            ...
                            <div class="owl-item">
                                <div class="trends_item is_new">
                                    <div
                                        class="trends_image d-flex flex-column align-items-center justify-content-center">
                                        <img src="{{ asset('uset/assets/images/trends_3.jpg') }}" alt="img">
                                    </div>
                                    <div class="trends_content">
                                        <div class="trends_category"><a href="#">Smartphones</a></div>
                                        <div class="trends_info clearfix">
                        ...
                        <div class="owl-carousel owl-theme reviews_slider">
                                ...
                                <div class="review d-flex flex-row align-items-start justify-content-start">
                                    <div>
                                        <div class="review_image"><img
                                                src="{{ asset('uset/assets/images/review_1.jpg') }}" alt="img">
                                        </div>
                                    </div>
                            ...
                            <div class="owl-item">
                                <div class="review d-flex flex-row align-items-start justify-content-start">
                                    <div>
                                        <div class="review_image"><img
                                                src="{{ asset('uset/assets/images/review_2.jpg') }}" alt="img">
                                        </div>
                                    </div>
                                    <div class="review_content">
                            ...
                            <div class="owl-item">
                                <div class="review d-flex flex-row align-items-start justify-content-start">
                                    <div>
                                        <div class="review_image"><img
                                                src="{{ asset('uset/assets/images/review_3.jpg') }}" alt="img">
                                        </div>
                                    </div>
                                    <div class="review_content">
                        ...
                        <div class="owl-carousel owl-theme brands_slider">
                            ...
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img
                                        src="{{ asset('uset/assets/images/brands_1.jpg') }}" alt="img"></div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img
                                        src="{{ asset('uset/assets/images/brands_2.jpg') }}" alt="img"></div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img
                                        src="{{ asset('uset/assets/images/brands_3.jpg') }}" alt="img"></div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img
                                        src="{{ asset('uset/assets/images/brands_4.jpg') }}" alt="img"></div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img
                                        src="{{ asset('uset/assets/images/brands_5.jpg') }}" alt="img"></div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img
                                        src="{{ asset('uset/assets/images/brands_6.jpg') }}" alt="img"></div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img
                                        src="{{ asset('uset/assets/images/brands_7.jpg') }}" alt="img"></div>
                            </div>
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img
                                        src="{{ asset('uset/assets/images/brands_8.jpg') }}" alt="img"></div>
                            </div>
