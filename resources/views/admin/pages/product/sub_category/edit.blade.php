        ...
        <div class="col-12 grid-margin stretch-card">
            ...
            <div class="card">
                <div class="card-body">
                    <x-card-title
                        title={{$title}} />
                    <form action="{{route('admin.product.sub-category.update',['sub_category' => $subCategory->id])}}" class="forms-sample material-form" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="h-100 px-2 pb-1" style="align-content: end;">
                                    <div class="form-group">
                                        <input type="text" name="subcategory_name" value="{{$subCategory->subcategory_name}}" required="required">
