...
<div class="content-wrapper">
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex flex-row flex-wrap text-start align-items-center">
                        <img src="{{ asset('aset/assets/images/faces/face11.jpg') }}" class="img-lg rounded" alt="profile image">
                        <div class="ms-sm-3 ms-md-0 ms-xl-3 mt-2 mt-sm-0 mt-md-2 mt-xl-0">
                            ...
                            <p class="mb-0 text-success fw-bold">Designer</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex flex-row flex-wrap text-start align-items-center">
                        <img src="{{ asset('aset/assets/images/faces/face9.jpg') }}" class="img-lg rounded" alt="profile image">
                        <div class="ms-sm-3 ms-md-0 ms-xl-3 mt-2 mt-sm-0 mt-md-2 mt-xl-0">
        ...
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex flex-row flex-wrap text-start align-items-center">
                        <img src="{{ asset('aset/assets/images/faces/face12.jpg') }}" class="img-lg rounded" alt="profile image">
                        <div class="ms-sm-3 ms-md-0 ms-xl-3 mt-2 mt-sm-0 mt-md-2 mt-xl-0">
                            <h6 class="mb-0">Edward</h6>
                            <p class="text-muted mb-1">edward@gmail.com</p>
                            <p class="mb-0 text-success fw-bold">Tester</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 grid-margin">
            <div class="card bg-twitter d-flex align-items-start">
                <div class="card-body">
                    <div class="d-flex flex-row align-items-start">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center pb-3 border-bottom">
                        <img class="img-sm rounded-circle" src="{{ asset('aset/assets/images/faces/face5.jpg') }}" alt="profile">
                        <div class="ms-3">
                            <h6 class="mb-1">Stella Davidson</h6>
                            <small class="text-muted mb-0"><i class="ti-location-pin me-1"></i>New York City, USA</small>
                        </div>
                        <i class="ti-check fw-bold ms-auto px-1 py-1 text-info mdi-24px"></i>
                    </div>
                    <div class="d-flex align-items-center py-3 border-bottom">
                        <img class="img-sm rounded-circle" src="{{ asset('aset/assets/images/faces/face6.jpg') }}" alt="profile">
                        <div class="ms-3">
                            <h6 class="mb-1">Daniel Russel</h6>
                            <small class="text-muted mb-0"><i class="ti-location-pin me-1"></i>Florida, USA</small>
                        </div>
                        <i class="ti-plus fw-bold ms-auto px-1 py-1 text-success mdi-24px"></i>
                    </div>
                    <div class="d-flex align-items-center py-3 border-bottom">
                        <img class="img-sm rounded-circle" src="{{ asset('aset/assets/images/faces/face7.jpg') }}" alt="profile">
                        <div class="ms-3">
                    ...
                    <div class="d-flex align-items-center py-3 border-bottom">
                        <img class="img-sm rounded-circle" src="{{ asset('aset/assets/images/faces/face8.jpg') }}" alt="profile">
                        <div class="ms-3">
                    ...
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-sm rounded-circle" src="{{ asset('aset/assets/images/faces/face9.jpg') }}" alt="profile">
                        <div class="ms-3">
        ...
        <div class="col-md-5 grid-margin grid-margin-md-0 stretch-card">
            <div class="card">
                <div class="card-body text-center">
                    <div>
                        <img src="{{ asset('aset/assets/images/faces/face5.jpg') }}" class="img-lg rounded-circle mb-2" alt="profile image">
                        <h4>Maria Johnson</h4>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-1 ps-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('aset/assets/images/faces/face1.jpg') }}" alt="profile">
                                            <div class="ms-3">
                                ...
                                <tr>
                                    <td class="py-1 ps-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('aset/assets/images/faces/face6.jpg') }}" alt="profile">
                                            <div class="ms-3">
                                ...
                                <tr>
                                    <td class="py-1 ps-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('aset/assets/images/faces/face15.jpg') }}" alt="profile">
                                            <div class="ms-3">
                                ...
                                <tr>
                                    <td class="py-1 ps-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('aset/assets/images/faces/face2.jpg') }}" alt="profile">
                                            <div class="ms-3">
                                ...
                                <tr>
                                    <td class="py-1 ps-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('aset/assets/images/faces/face3.jpg') }}" alt="profile">
                                            <div class="ms-3">
