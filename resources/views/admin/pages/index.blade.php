                                                     ...
                                                     <table class="table select-table">
                                                         ...
                                                         <tbody>
                                                             <tr>
                                                                 ...
                                                                 <td>
                                                                     <div class="d-flex ">
                                                                         <img src="{{ asset('aset/assets/images/faces/face1.jpg') }}" alt="">
                                                                         <div>
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <td>
                                                                     <div class="d-flex">
                                                                         <img src="{{ asset('aset/assets/images/faces/face2.jpg') }}" alt="">
                                                                         <div>
                                                                             <h6>Laura Brooks</h6>
                                                                             <p>Head admin</p>
                                                                         </div>
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <td>
                                                                     <div class="d-flex">
                                                                         <img src="{{ asset('aset/assets/images/faces/face3.jpg') }}" alt="">
                                                                         <div>
                                                                             <h6>Wayne Murphy</h6>
                                                                             <p>Head admin</p>
                                                                         </div>
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <td>
                                                                     <div class="d-flex">
                                                                         <img src="{{ asset('aset/assets/images/faces/face4.jpg') }}" alt="">
                                                                         <div>
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <td>
                                                                     <div class="d-flex">
                                                                         <img src="{{ asset('aset/assets/images/faces/face5.jpg') }}" alt="">
                                                                         <div>
                                                 ...
                                                 <div class="row">
                                                     <div class="col-lg-12">
                                                         ...
                                                         <div class="mt-3">
                                                             ...
                                                             <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                                                 <div class="d-flex">
                                                                     <img src="{{ asset('aset/assets/images/faces/face4.jpg') }}" alt="profile">
                                                                     <div class="wrapper ms-3">
                                                             ...
                                                             <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                                                 <div class="d-flex">
                                                                     <img src="{{ asset('aset/assets/images/faces/face5.jpg') }}" alt="profile">
                                                                     <div class="wrapper ms-3">
